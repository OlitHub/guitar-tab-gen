...
% State of the art (survey, DadaGP, Compound Gen)

%Challenges (tokenization, conditional generation)

% What we have done (data preprocessing, getting the rythlic instrument, retrieving the tokens)
